...
import { EraseAll } from "../Context/CartFunctions";
        ...
        axios
          ...
          .then((resp) => {
            if (resp.status == 200) {
              ...
              axios
                .post("http://localhost:8081/pedido/ultimo", pedido)
                .then((resp) => {
                  console.log(resp.data.NF);
                  EraseAll(context);
                  window.alert(
                    `SEU PEDIDO FOI CRIADO COM A NF: ${resp.data.NF}`
                  );
